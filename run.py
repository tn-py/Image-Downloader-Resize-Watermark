...
# Example usage
image_urls = [
'Insert_URL_Here', 'Insert_URL_Here', 'Insert_URL_Here', 'Insert_URL_Here' ]
output_folder = '\Image-Downloader-Resize-Watermark\Post Edit Images'
size = (600, 600)
watermark_path = 'Image-Downloader-Resize-Watermark\Watermark\Preorder-Model-Banner.png'
